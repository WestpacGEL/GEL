...
const { version } = require(path.normalize(`${__dirname}/../../components/${PACKAGE_NAME}/package.json`));
...
const code = makeCode(findExampleFiles(PACKAGE_NAME, PACKAGE_NAME), 'start.js', PACKAGE_NAME, version);
