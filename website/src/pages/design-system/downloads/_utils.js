...
const fontTextWBC = () => (
	<Fragment>
		<p>
			Check the Masterbrand guidelines to understand how to use brand fonts effectively. Never use a
			web font without confirmation that you have the correct license in place.
		</p>
		<p>Designers using Sketch can access within the Sketch UI Kit.</p>
		<p>
...
const fontTextWBG = () => (
	<Fragment>
		<p>Check the Masterbrand guidelines to understand how to use brand fonts effectively.</p>
		<p>
