...
const VisionFilterIntro = () => (
	<Fragment>
		All our components are designed and tested to ensure their colour contrast ratios comply with
		WCAG 2.1AA. Select a filter from the list to see this component as it would appear to someone
		with a{' '}
