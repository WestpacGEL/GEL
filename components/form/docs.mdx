...
<Playground>
	<FormGroup>
		...
		<Hint>This is a hint</Hint>
		<ErrorMessage>This is an error message</ErrorMessage>
		<TextInput name="example-formgroup" id="example-formgroup" />
	</FormGroup>
</Playground>
...
<Alert appearance="information" icon={AlertIcon}>
	...
	component has an `aria-described` prop with its value matching the associated Hint component’s
	`id` prop value.
</Alert>

<Playground>
	<FormGroup>
		<FormLabel htmlFor="example-hint-input" aria-describedby="example-hint">
			This is a label
		</FormLabel>
		<Hint id="example-hint">This is a hint</Hint>
		<TextInput name="example-hint-input" id="example-hint-input" />
	</FormGroup>
	<FormGroup>
...
<Alert appearance="information" icon={AlertIcon}>
	...
	component has an `aria-described` prop with its value matching the associated ErrorMessage
