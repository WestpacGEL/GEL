    	...
    	<FormSection>
    		...
    		<FormGroup>
    			<Fieldset legend="This is a legend">
    				...
    				<InputCluster>
    					<InputClusterItem>
    						<FormLabel htmlFor="example-fieldset-line1" isSublabel>This is a sub-label</FormLabel>
    						<TextInput name="example-fieldset-line1" id="example-fieldset-line1" />
    					</InputClusterItem>
    					<InputClusterItem>
    						<FormLabel htmlFor="example-fieldset-line2" isSublabel>This is a sub-label</FormLabel>
...
Use the `isPrimary` prop to centre the contents of a FormGroup. This option is used exclusively to render the ‘Fork’ pattern — a primary FormGroup wrapping a ButtonGroup component.
	...
	<FormGroup>
		<Fieldset legend="Date of birth" aria-describedby="example-fieldset-hint">
			...
			<InputCluster isHorizontal>
				<InputClusterItem>
					<FormLabel htmlFor="example-fieldset-input-1" isSublabel>
						Day
					</FormLabel>
					<TextInput
						type="number"
				...
				<InputClusterItem>
					<FormLabel htmlFor="example-fieldset-input-2" isSublabel>
						Month
					</FormLabel>
					<TextInput
						type="number"
				...
				<InputClusterItem>
					<FormLabel htmlFor="example-fieldset-input-3" isSublabel>
						Year
					</FormLabel>
					<TextInput
						type="number"
...
<Playground>
	<FormGroup>
		<Fieldset legend="This is a legend">
			<InputCluster>
				<InputClusterItem>
					<FormLabel htmlFor="example-formlabel-sublabel-1" isSublabel>
						This is a sub-label
					</FormLabel>
					<TextInput name="example-formlabel-sublabel-1" id="example-formlabel-sublabel-1" />
				</InputClusterItem>
				<InputClusterItem>
					<FormLabel htmlFor="example-formlabel-sublabel-2" isSublabel>
...
<Playground>
	<FormGroup>
		<Fieldset legend="This is a legend">
			<InputCluster>
				<InputClusterItem>
					<FormLabel htmlFor="example-formlabel-sronly-1" isSrOnly>
						This is a ‘screen reader only’ label
					</FormLabel>
					<TextInput name="example-formlabel-sronly-1" id="example-formlabel-sronly-1" />
				</InputClusterItem>
				<InputClusterItem>
					<FormLabel htmlFor="example-formlabel-sronly-2" isSrOnly>
...
The `isHorizontal` mode changes the layout to inline. This mode is used to render the ‘Date of birth’ and ‘Expiry date’ patterns.
