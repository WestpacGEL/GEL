	...
	return (
		<Playground context={context} showCode={showCode} showDemo={showDemo}>
			<Form spacing="large">
				...
				{value === 'provide-later' && (
					<Alert>
						You can provide your TFN at any time via phone or at a Westpac branch. In the meantime,
						please note, we may need to withhold tax from any interest you earn.
					</Alert>
				)}
			</Form>
		</Playground>
