...
export default () => (
	<>
		...
		<p>
			...
			<Button appearance="hero" size="small">Hero</Button>{' '}
			<Button appearance="neutral" size="small">Neutral</Button>{' '}
			<Button appearance="faint" size="small">Faint</Button>{' '}
		...
		<p>
			...
			<Button appearance="hero" size="large">Hero</Button>{' '}
			<Button appearance="neutral" size="large">Neutral</Button>{' '}
		...
		<h3>Extra large</h3>
		<p>
			<Button appearance="primary" size="xlarge">Primary</Button>{' '}
			<Button appearance="hero" size="xlarge">Hero</Button>{' '}
			<Button appearance="neutral" size="xlarge">Neutral</Button>{' '}
