	...
	return (
		<Fragment>
			<GEL brand={brand}>
				...
				<h2>With text</h2>
				<p>
					Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aut, repellat iusto velit in
					rerum molestias cupiditate ea doloribus assumenda tenetur, neque, deserunt quis atque illo
					aperiam fuga, vel labore alias!
				</p>
				<Heading size={1}>Heading size: 1</Heading>
				<p>
					Lorem ipsum dolor sit amet, consectetur adipisicing elit. Obcaecati iusto porro optio,
					cupiditate atque ipsum animi quo ullam, nemo soluta ut at fugiat pariatur facere,
					laboriosam exercitationem. Architecto odit, dolore.
				</p>
				<Heading size={2}>Heading size: 2</Heading>
				<p>
				...
				<p>
					...
					adipisci optio perspiciatis exercitationem recusandae modi doloremque non odit fugiat,
					totam numquam provident magnam, vitae ipsa ullam.
				</p>
				<Heading size={4}>Heading size: 4</Heading>
				<p>
				...
				<p>
					...
					voluptate rerum optio quisquam quia laudantium deleniti, ducimus, cum aperiam explicabo
					eum exercitationem. Molestiae dolorem, sunt ut velit.
				</p>
				<Heading size={6}>Heading size: 6</Heading>
				<p>
				...
				<p>
					...
					provident odio soluta incidunt? Consequuntur, omnis, hic numquam, dignissimos
					necessitatibus fugiat voluptatibus unde ea ab ipsam, laborum quidem.
				</p>
				<Heading size={9}>Heading size: 9</Heading>
				<p>
