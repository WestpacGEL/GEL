...
export default () => (
	<>
		...
		<Switch name="ex1" size={['medium', 'xlarge']} block>
			Extra large for MD breakpoint and wider
		</Switch>
		<Switch name="ex2" size={['small', null, 'xlarge']} block>
		...
		<Switch name="ex3" size={['medium', null, 'xlarge', 'medium']} block>
			Extra large for LG breakpoint only
		</Switch>
		<Switch name="ex4" size={['medium', null, 'small', 'medium']} block>
			Small for LG breakpoint only
		</Switch>
		<Switch name="ex5" size={['small', 'xlarge', 'small']} block>
