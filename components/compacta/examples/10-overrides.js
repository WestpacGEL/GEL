...
function Example({ brand }) {
	...
	overridesWithTokens['@westpac/compacta'] = {
		Item: {
			styles: (styles) => ({
				...styles,
	...
	return (
		<GEL brand={overridesWithTokens}>
			...
			<h3>With overrides applied and componentOverrides</h3>
			<Compacta
				overrides={{
					Item: { styles: (styles) => ({ ...styles, border: '2px dashed midnightblue' }) },
				}}
			>
				{({ id, setPrimaryTitle, setSecondaryTitle, setTertiaryTitle }) => (
					<Form spacing="large">
