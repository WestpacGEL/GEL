...
export default () => (
  <>
    ...
    <h2>Inputs</h2>
    <p>
      Note: All users should see our focus outline styling; not just keyboard
      users.
    </p>
    {/* <TextInput />
		<br />
    ...
    <p>
      Note: The following headings should show focus outline styling when
      keyboard tabbing.
    </p>
    ...
    <p>
      Note: The following headings should NOT show focus outline styling when
      keyboard tabbing.
    </p>
