...
const Demo = ({ context, showCode, showDemo }) => {
	...
	const shortContent = `Sudden and magnificent, the sun's broad golden disc showed itself over the horizon facing them.`;
	return (
		<Playground context={context} showCode={showCode} showDemo={showDemo}>
			<Popover heading="Sudden and magnificent" content={content} look="primary" soft>
				With heading
			</Popover>{' '}
			<Popover content={shortContent} look="primary" soft>
				No heading
			</Popover>
		</Playground>
	);
