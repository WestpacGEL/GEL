...
export default () => (
	<>
		<Alert appearance="success" type="AlertBox" icon={InfoIcon}>
		...
		<Alert appearance="information" type="AlertBox" icon={InfoIcon}>
			<strong>Heads up!</strong> This alert needs your attention, but it’s not super important.{' '}
			<a href="#">Link</a>
		</Alert>
		<Alert appearance="warning" type="AlertBox" icon={InfoIcon}>
			<strong>Warning!</strong> Better check yourself, you’re not looking too good.{' '}
			<a href="#">Link</a>
		</Alert>
		<Alert appearance="danger" type="AlertBox" icon={InfoIcon}>
			<strong>Oh snap!</strong> Change a few things up and try submitting again.{' '}
			<a href="#">Link</a>
		</Alert>
		<Alert appearance="system" type="AlertBox" icon={InfoIcon}>
		...
		<Alert appearance="success" type="AlertBox">
