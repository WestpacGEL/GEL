...
import { identity, objMerge, unique, flatMap } from '@keystonejs/utils';
...
var BlockquoteBlock = /*#__PURE__*/function (_Block) {
  ...
  function BlockquoteBlock() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(BlockquoteBlock).apply(this, arguments));
  }
...
var HeadingBlock = /*#__PURE__*/function (_Block) {
  ...
  _createClass(HeadingBlock, [{
    key: "getAdminViews",
    value: function getAdminViews() {
      return [importView('../views/editor/blocks/heading')].concat(_toConsumableArray(new ParagraphBlock().getAdminViews()));
    }
  }, {
    key: "type",
    get: function get() {
...
var ImageContainerBlock = /*#__PURE__*/function (_Block) {
  ...
  function ImageContainerBlock() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(ImageContainerBlock).apply(this, arguments));
  }

  _createClass(ImageContainerBlock, [{
    key: "getAdminViews",
    value: function getAdminViews() {
      return [importView('../views/editor/blocks/image-container')].concat(_toConsumableArray(new ImageBlock().getAdminViews()), _toConsumableArray(new CaptionBlock().getAdminViews()));
    }
  }, {
    key: "type",
    get: function get() {
...
var OrderedListBlock = /*#__PURE__*/function (_Block) {
  ...
  function OrderedListBlock() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(OrderedListBlock).apply(this, arguments));
  }

  _createClass(OrderedListBlock, [{
    key: "getAdminViews",
    value: function getAdminViews() {
      return [importView('../views/editor/blocks/ordered-list')].concat(_toConsumableArray(new ListItemBlock().getAdminViews()));
    }
  }, {
    key: "type",
    get: function get() {
...
var UnorderedListBlock = /*#__PURE__*/function (_Block) {
  ...
  function UnorderedListBlock() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(UnorderedListBlock).apply(this, arguments));
  }

  _createClass(UnorderedListBlock, [{
    key: "getAdminViews",
    value: function getAdminViews() {
      return [importView('../views/editor/blocks/unordered-list')].concat(_toConsumableArray(new ListItemBlock().getAdminViews()));
    }
  }, {
    key: "type",
    get: function get() {
...
function _processSerialised() {
  _processSerialised = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(document, blocks, graphQlArgs) {
...
var Content = /*#__PURE__*/function (_Relationship$impleme) {
  ...
  function Content(path, _ref, listConfig) {
    ...
    var type = "".concat(GQL_TYPE_PREFIX, "_").concat(itemQueryName, "_").concat(path); // Normalise blocks to always be a tuple with a config object
    ...
    if (!auxList) {
      auxList = listConfig.createAuxList(type, {
        ...
        }, objMerge(blockInstances.map(function (block) {
              ...
              return _regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      resolvedData = _ref4.resolvedData, args = _objectWithoutProperties(_ref4, ["resolvedData"]);
                    ...
                    case 6:
                      ...
                      return _context.abrupt("return", _objectSpread({}, resolvedData, {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Content).call(this, path, config, listConfig));
  ...
  _createClass(Content, [{
    ...
    value: function extendAdminViews(views) {
      return _objectSpread({}, views, {
        blocks: unique(flatMap(this.blocks, function (block) {
...
var MongoContentInterface = /*#__PURE__*/function (_Relationship$adapter) {
  ...
  function MongoContentInterface() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(MongoContentInterface).apply(this, arguments));
  }

  return MongoContentInterface;
}(Relationship.adapters.mongoose);
var KnexContentInterface = /*#__PURE__*/function (_Relationship$adapter2) {
  ...
  function KnexContentInterface() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(KnexContentInterface).apply(this, arguments));
  }

  return KnexContentInterface;
}(Relationship.adapters.knex);
